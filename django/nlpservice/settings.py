"""
Django settings for nlpservice project.
...
SECRET_KEY = '$8z1dzwiis2a70ty*4%7bbjif8wj1n#jc^7ky!emc-gs$0(3&='
...
WSGI_APPLICATION = 'nlpservice.wsgi.application'
...
NLPSERVICE_REDIS_PORT = os.getenv('NLPSERVICE_REDIS_PORT', 6379)
